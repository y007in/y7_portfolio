          ...
          <div className="project_right">
            ...
            <div className="project_func">
              ...
              <div className="des_content">
                산후조리원코드로 임산부들만 회원가입 가능합니다. 회원가입시 남편
                정보 입력해 남편도 회원가입할 수 있도록 합니다. 추천인으로
                포인트 적립할 수 있는 기능이 있습니다. 산후조리원 안에 있는
                산모들용 / 산후조리원을 나온 산모들용 페이지 분리 라이브커머스로
                특가상품 소개와 실시간으로 주문이 가능합니다. (모두 적용)
                산후조리원코드로 임산부들만 회원가입 가능합니다. 회원가입시 남편
                정보 입력해 남편도 회원가입할 수 있도록 합니다. 추천인으로
                포인트 적립할 수 있는 기능이 있습니다. 산후조리원 안에 있는
                산모들용 / 산후조리원을 나온 산모들용 페이지 분리 라이브커머스로
