  ...
  },
  {
    ...
    result: (
      <p className="des_result">
        ...
        실제 사용까지 이어질 수 있도록 하는 활동이었습니다. 이 프로젝트의 1차
        과제는 확장앱 제작이었습니다. 이 프로젝트를 통해 처음으로 다양한 직무의
        사람들과 협업을 할 수 있었습니다. 프로젝트가 완성되는 과정에서 각 분야가
        어떤 부분에 주의를 기울이고 필요로 하는지에 대한 인사이트를 얻을 수
        있었습니다. 다양한 직무의 사람들과 협업하면서, 기획과 UI 디자인에 대해
        자세히 알지 못하는 저에게는 높은 퀄리티의 그러나 항상 저만의 스타일로
        작업해왔기에 다른 팀원들이 원하는 기술을 구현하기 어려운 부분도
        있었습니다. 이러한 과정은 어렵지만 협업에서 나아가 문제에 대한 해결책을
        찾아 나가는 용기를 길러주는 시간이었습니다. 당시에는 완벽하게 완성되지
        않았지만, 추후에 기능을 추가하고 보다 다듬어 확장앱으로서의 가치를 높여
        등록할 계획입니다. 이러한 경험을 통해 지속적인 성장과 더 나은 결과물을
        만들어내기 위해 노력하고 있습니다.
      </p>
    ),
  },
