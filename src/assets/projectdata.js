...
export const ProjectData = [
  ...
  },
  {
    ...
    dev_func: (
      <>
        <li>
          <h2>localStrorage에 사용자가 작성한 답변 저장</h2>
          <ul>
            <li>
              날짜에 따라 질문과 값들이 작동하도록 해야하기 때문에 각 다른
              사용자가 저장하는 데이터의 정보에 따라 작동하도록 하였습니다.
            </li>
            <li>
              질문의 id값, 답변 내용, 답 존재여부, 날짜를 localStorage에
              저장하여 데이터가 유지할 수 있도록 설계하였습니다.
            </li>
            <li>
              localStorage에 마지막으로 저장된 답변의 날짜가 오늘의 날짜와 같지
              않고 exist가 true이면 exist를 false로 바꿔주며 날짜마다 다른
              질문이 출력될 수 있도록 하였습니다.
            </li>
          </ul>
        </li>
    ...
    dev_func: (
      <>
        <li>
          ...
          <ul>
            <li>
              모바일과 데스크탑 사이즈의 반응형 웹으로 사이즈에 따라 레이아웃이
              변경될 수 있도록 하였습니다.
            </li>
          </ul>
        </li>
        <li>
          <h2>자바스크립트를 활용한 기능 구현</h2>
        </li>
      </>
    ),
    role: (
  ...
  },
  {
    ...
    des: (
      <p>
        보드픽은 기존 보드게임 정보 제공 서비스가 헤비 유저들을 대상의 서비스로
        라이트 유저들의 불편함을 해소하고 친근하게 다가가기 위한 보드게임 정보
        제공 사이트 입니다.
      </p>
    ),
    ...
    role: (
      <ul>
        <li>프로젝트 전체적인 방향성과 기획 참여</li>
        <li>프로젝트 개발 기초 세팅</li>
        <li>로그인 페이지 및 마이페이지 개발</li>
        <li>보드게임에 대한 정보를 제공하는 보드게임 상세페이지 개발</li>
        <li>
          선호하는 보드게임 PICK 기능 및 PICK한 보드게임을 모아볼 수 있는 MY
          PICK 페이지 개발
        </li>
      </ul>
    ),
    ...
    dev_func: (
      <>
        <li>
          ...
          <ul>
            <li>
              max-width : 600px / min-width : 375px로 지정하여 사이즈에 따라
              스타일과 레이아웃이 변경될 수 있도록 하였습니다.
            </li>
            <li>
              Sass의 mixin과 include와 variables를 사용하여 재사용성을
              높였습니다.
            </li>
            <li>
              Swiper 라이브러리를 활용한 캐러셀(Carousel) 슬라이드에
              slidePerView(슬라이드에 보이는 개수)를 resize 커스텀 훅으로 페이지
              사이즈에 따라 화면에 보이는 갯수가 변경되도록 설정하였습니다.
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul>
            <li>
              공통적으로 사용되는 부분들(네비게이션바, 보드게임 썸네일, 캐러셀
              슬라이드 등)을 따로 노션에 정리하여 다른 프론트엔드 개발자분과
              공유하며 협업 편리성 증가하였습니다.
            </li>
            <li>중복 코드를 줄이고 간편하게 개발 가능하였습니다.</li>
          </ul>
        </li>
        <li>
          <h2>Axios 라이브러리를 통한 API 연결</h2>
          <ul>
            <li>
              Axios가 Fetch보다 간단하게 코드를 작성 가능하며 더 다양한
              브라우저를 지원하기 때문에 Axios 활용하였습니다.
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul>
            <li>
              각 보드게임의 picked가 true가 되면 get-ids API 배열에 해당 id가
              저장되어, 배열 속에 해당 보드게임의 id가 있을 시 pick 표시
              유지하였습니다.
            </li>
          </ul>
        </li>
        <li>
          <h2>Redux를 활용한 상태관리</h2>
          <ul>
            <li>상태 관리를 효율적으로 하기 위해 Redux를 활용하였습니다.</li>
          </ul>
        </li>
      </>
    ),
    ...
    //     <li>보드게임에 대한 정보를 제공하는 보드게임 상세페이지 개발</li>
    //     <li>
    //       선호하는 보드게임 PICK 기능 및 픽한 보드게임을 모아볼 수 있는 MY PICK
    //       페이지 개발
    //     </li>
    //   </>
    // ),
